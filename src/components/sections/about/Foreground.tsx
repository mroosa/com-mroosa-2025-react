...
const Foreground = ({brickCallback}: {brickCallback: CallableFunction}) => {
    ...
    return (
        <div className="contain" role="presentation">
            <h2>
                <Brick letter="A" handleClick={handleBrickClick} />
                <Brick letter="B" handleClick={handleBrickClick} />
                <Brick letter="O" handleClick={handleBrickClick} special />
                <Brick letter="U" handleClick={handleBrickClick} />
                <Brick letter="T" handleClick={handleBrickClick} />
            </h2>
